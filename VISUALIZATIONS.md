...
![Singlet Histogram](histogram_singlet.png)
...
* **Prepared State: $|\psi_{\text{triplet\_plus}}\rangle = \frac{1}{\sqrt{2}}(|01\rangle + |10\rangle)$**
  ![Triplet Plus Histogram](histogram_triplet_plus.png)

* **Prepared State: $|00\rangle$**
  ![Triplet 00 Histogram](histogram_triplet_00.png)

* **Prepared State: $|11\rangle$**
  ![Triplet 11 Histogram](histogram_triplet_11.png)
